...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'doufi515@gmail.com', // Your email address
    pass: 'kmul rrqg ztlh irxv', // Your email password or an app-specific password for security
  },
});
...
app.post('/loginsms', async (req, res) => {
    ...
    try {
        ...
        const emailOptions = {
    from: '"DOUFI 🔥👑" <doufi515@gmail.com>', // Setting the sender's name and email
